...
"""
   如果抛出的异常实例对象所对应的类对象是except子句中异常类对象的子类，那么该except子句
也会被匹配。
"""
try:
    result = 1 / 0
...
"""
    当多个异常类对象对应的异常处理代码完全相同时，可以把这些异常类对象以元组的形式放在
一个except子句中。
"""
try:
    # result = 1 / 0
...
"""
    为了在except语句块中将所有的异常类对象尽可能地覆盖到，可以将最后一个except子句中的
