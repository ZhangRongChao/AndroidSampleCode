...
4. delattr(object, name)
    ...
    注意：只有在不知道对象信息的情况下，才会去获取对象的信息。因此，如果可以直接写：object.x，
就不要写为：getattr(object, 'x')。
"""
